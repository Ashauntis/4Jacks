...
class Title(Scene):
    def __init__(self, game):
        ...
        text_hot_seat = self.game.make_text("Play vs Local Hot Seat", (50, 50, 50), 24)
        text_ai = self.game.make_text("Play vs AI", (50, 50, 50), 24)
        text_quit = self.game.make_text(
            text="Esc/Q to Quit", color=(80, 80, 80), fontSize=24
        )

        self.text_ai_color = []
        self.text_ai_color.append(
            self.game.make_text("AI Color: Red   ", (50, 50, 50), 8 * 2)
        )
        self.text_ai_color.append(
            self.game.make_text("AI Color: Yellow", (50, 50, 50), 8 * 2)
        )
        self.text_ai_color.append(
            self.game.make_text("AI Color: Random", (50, 50, 50), 8 * 2)
        )
